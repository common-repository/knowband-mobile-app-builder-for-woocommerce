...
var velovalidation = {
	...
	error: function (key) {
		var error_arr = {
			...
			empty_field: $( "#empty_field" ).val(),
			number_field: $( "#number_field" ).val(),
			positive_number: $( "#positive_number" ).val(),
			maxchar_field: $( "#maxchar_field" ).val(),
			minchar_field: $( "#minchar_field" ).val(),
			empty_email: $( "#empty_email" ).val(),
			validate_email: $( "#validate_email" ).val(),
			...
			validate_range: $( "#validate_range" ).val(),
			...
			valid_percentage: $( "#valid_percentage" ).val(),
			between_percentage: $( "#between_percentage" ).val(),
			...
			invalid_color: $( "#invalid_color" ).val(),
			specialchar: 'Special characters are not allowed.',
			script: $( "#script" ).val(),
			style: $( "#style" ).val(),
			iframe: $( "#iframe" ).val(),
			not_image: $( "#not_image" ).val(),
			image_size: $( "#image_size" ).val(),
			html_tags: $( "#html_tags" ).val(),
			number_pos: $( "#number_pos" ).val(),
